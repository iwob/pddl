...
from pddl.logic.base import And, Formula, is_literal, Literal
...
class Space:
    """A class for a PDDL space file (as generated by GLAIVE)."""

    def __init__(
        self,
        name: namelike,
        literals: Optional[Collection[Literal]] = None,
        steps: Optional[Collection[Predicate]] = None,
        axioms: Optional[Collection["Axiom"]] = None,
    ):
        """
        Initialize a PDDL space.

        :param name: the name of the domain.
        :param literals: all literals that can be added/deleted to the state.
        :param steps: all steps that can be executed.
        :param axioms: the axioms.
        """
        self._name = parse_name(name)
        self._literals = ensure_set(literals)
        self._steps = ensure_set(steps)
